...
def test_notify():
    msg = messaging.Message(
        ...
        token="d0CHTjx_PkYghntyKbk48Q:APA91bHSIRPU7VF6QHmSExdTt3wfZMyLFraByot-mwaqBNG36YrgjYJDck-ElwlTYQFPxGB9s-9RwoxSIVwmPt86zUIoW6_GvqRjwiX2mNiBHflHJsNPerk",
    )
    response = messaging.send(msg)
    print("Successfully sent msg:", response)
    return jsonify(msg.notification.body), 200
