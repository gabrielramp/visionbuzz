...
CANONICAL_LANDMARK_COORDS = {
        'frontal': np.float32([
            [38.2946 / 112, 51.6963 / 112],   # Left eye
            [73.5318 / 112, 51.5014 / 112],   # Right eye
            [56.0252 / 112, 72.9165 / 112],   # Nose
            [41.5493 / 112, 92.3655 / 112],   # Left mouth corner
            [70.7299 / 112, 92.2041 / 112]    # Right mouth corner
            ]),
        }
...
class YuNetMultiViewAligner:
    ...
    def _estimate_pose(self, landmarks) -> str:
        ...
        # tried including other poses but accuracy didn't improve
        pose = 'frontal'
        return pose
    ...
    def _get_transformation_matrix(self, box, landmarks, pose) -> np.ndarray:
        ...
        try:
            # Note, affinePartial does not allow sheering (which is good)
