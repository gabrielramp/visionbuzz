...
#define API_SERVICE_UUID        {0x69, 0x00, 0x00, 0x00, 0x42, 0x00, 0x12, 0x34, 0x56, 0x78, 0x9A, 0xBC, 0xDE, 0xF0, 0x02, 0x00}
#define API_TOKEN_UUID          {0x69, 0x00, 0x00, 0x00, 0x42, 0x00, 0x12, 0x34, 0x56, 0x78, 0x9A, 0xBC, 0xDE, 0xF0, 0x02, 0x01}

#define BLE_NUM_SERVICES 3
#define BLE_NUM_VIBRATOR_CHARACTERISTICS 1
#define BLE_NUM_WIFI_CHARACTERISTICS 6
#define BLE_NUM_API_CHARACTERISTICS 1
...
typedef esp_err_t (*ble_chrc_write_cb)(uint16_t len, uint16_t offset);
